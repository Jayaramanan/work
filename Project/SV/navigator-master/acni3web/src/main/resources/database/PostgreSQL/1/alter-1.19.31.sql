...
CREATE OR REPLACE FUNCTION alterDatabase()
 RETURNS void AS $$
DECLARE 
	_expectedVersion varchar = '1.19.30';
	_newVersion varchar = '1.19.31';
	_version varchar;
BEGIN
	-- check version
...
-- Function: appendnodemetaphor(bigint, boolean)
...
$BODY$
	...
	AddTableColumns cursor is 
        select distinct 'ALTER TABLE SYS_NodeMetaphor ADD '||lower(t.name)||' integer NULL;'
...
-- Function: appendschematables(bigint, bigint)
