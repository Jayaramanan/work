...
$.widget("daredevel.checkboxTree", {
    ...
    _create: function() {
        ...
        if (this.options.collapsable) {
            ...
            if(typeof this.options.leafImage === "function")
                this.options.leafAnchor = this.options.leafImage;
            else
    ...
    _markAsLeaf: function(li) {
        if (typeof this.options.leafAnchor === "function"){
            this.options.leafAnchor(li);
        } else if(this.options.leafAnchor.length > 0){
            li.children("span").html(this.options.leafAnchor);
        } else if (this.options.leafUiIcon.length > 0) {
    ...
    _uncheckAncestors: function(li) {
        li.parentsUntil(".ui-widget").filter('li').children().filter("input:checkbox:first:checked").attr('checked', false).change();
