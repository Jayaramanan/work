...
public class DeltaUserCheckTask extends HibernateDaoSupport implements DiagnosticTask{

	private static final String MY_DESCRIPTION = "Checking sys_delta_user table";
	...
	public DiagnoseTaskResult makeDiagnose(Schema sch){
		Integer recordCount = deltaUserDAO.getUnprocessedRecordCount();
		...
		DeltaThreshold dt = id.getDeltaOutThreshold();
		if (dt != null){
