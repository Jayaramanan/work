...
public class AlwaysErrorDiagnoseTask implements DiagnosticTask{
	private static final String DESCRIPTION = "Fake test Always error";
	...
	public DiagnoseTaskResult makeDiagnose(Schema sch){
		return new DiagnoseTaskResult(getClass().getName(), DESCRIPTION, true, DiagnoseTaskStatus.Error, null, null);
	}

	@Override
	public DiagnoseTaskResult makeFix(DiagnoseTaskResult taskResult) throws ACFixTaskException{
		Logger.getLogger(this.getClass()).info("Make fake correction of Error task");
