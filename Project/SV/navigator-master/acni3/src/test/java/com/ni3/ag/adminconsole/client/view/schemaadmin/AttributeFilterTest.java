...
public class AttributeFilterTest extends ACTestCase{
	...
	public void testGetFormattedTextAllAllowedZeroOffset(){
		...
		assertEquals("abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZ0123456789_",
		        f.getFormattedText(0, "abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZ0123456789_"));
	}

	public void testGetFormattedTextAllAllowedNotZeroOffset(){
		assertEquals("123ABC456de_", f.getFormattedText(1, "123ABC456de_"));
		assertEquals("0123456789abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZ_",
		        f.getFormattedText(1, "0123456789abcdefghigklmnopqrstuvwxyzABCDEFGHIGKLMNOPQRSTUVWXYZ_"));
	}
}
