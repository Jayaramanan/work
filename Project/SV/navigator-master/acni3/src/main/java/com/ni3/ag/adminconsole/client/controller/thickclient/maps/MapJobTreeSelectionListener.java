...
public class MapJobTreeSelectionListener extends SchemaTreeSelectionListener{

	private MapJobController controller;

	public MapJobTreeSelectionListener(MapJobController controller){
	...
	public void changeValue(TreeSelectionEvent e){
		...
		MapJobModel model = (MapJobModel) controller.getModel();
