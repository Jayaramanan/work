...
public class AdminConsoleLicenseView extends JPanel implements AbstractView, ErrorRenderer{
	...
	private AdminConsoleLicenseView(){
	}
	...
	public void initializeComponents(){
		...
		ACLicenseBooleanCellRenderer renderer = new ACLicenseBooleanCellRenderer();
	...
	public UserACEditionTableModel getTableModel(){
		TableModel model = userTable.getModel();
		return (model instanceof UserACEditionTableModel) ? (UserACEditionTableModel) model : null;
	}
	...
	public void setActiveTableRow(User user){
		...
		UserACEditionTableModel model = getTableModel();
	...
	public void setTableModel(UserACEditionTableModel tableModel){
		userTable.setModel(tableModel);
		userTable.setRowSorter(new TableRowSorter<UserACEditionTableModel>(tableModel));
		updateTableHeaders();
	}
	...
	public void setTreeModel(ACLicenseTreeModel treeModel){
