...
public class ACLicenseTreeModel extends AbstractTreeModel{

	private static final long serialVersionUID = 1L;
	private List<DatabaseInstance> dbNames;
	private final ACRootNode rootNode;

	public ACLicenseTreeModel(List<DatabaseInstance> dbNames){
	...
	public void setDBNames(List<DatabaseInstance> dbNames){
		this.dbNames = dbNames;
	}
