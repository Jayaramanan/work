...
public class SchemaTreeModel extends AbstractTreeModel{
	...
	public SchemaTreeModel(Map<DatabaseInstance, List<Schema>> schemaMap, List<DatabaseInstance> dbNames){
	...
	public boolean isLeaf(Object node){
		if (rootNode.equals(node) || node instanceof DatabaseInstance || node instanceof Schema){
			return false;
		}
		return true;
	}
