...
public class XLSSchemaExporter implements Exporter{
	...
	public XLSSchemaExporter(SchemaAdminController schemaAdminController){
	...
	public boolean doExport(){
		...
		try{
			...
			file.createNewFile();
			ExportData exportData = service.getSchemaExport(schema.getName());
