...
public class AttributeFavoriteReferenceRuleTest extends TestCase{
	...
	public void testGetReferencedFavoritesNoReferences(){
		...
		AttributeFavoriteReferenceRule rule = new AttributeFavoriteReferenceRule();
		assertEquals(0, rule.getReferencedFavorites(oa, "1", favorites).size());
		assertEquals(0, rule.getReferencedFavorites(oa, "28", favorites).size());
	}
