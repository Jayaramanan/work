...
CREATE OR REPLACE FUNCTION alterDatabase()
 RETURNS void AS $$
DECLARE 
	_expectedVersion varchar = '1.48.14';
	_newVersion varchar = '1.48.15';
	_version varchar;
	_cc integer;
BEGIN
	-- check version
...
------------------------------------------------------------
update sys_user_language set value = '<html><body><center>Ni3 Navigator (c) version @VER</center> <br>Copyright (c) 2006-2015 '||
        '<a href="http://www.social-vision.ch" target="_blank">Social Vision GmbH</a>. All rights reserved. <br><br>'||
