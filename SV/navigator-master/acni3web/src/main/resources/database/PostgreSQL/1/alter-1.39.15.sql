...
CREATE OR REPLACE FUNCTION alterDatabase()
 RETURNS void AS $$
DECLARE 
	_expectedVersion varchar = '1.39.14';
	_newVersion varchar = '1.39.15';
	_version varchar;
BEGIN
	-- check version
...
------------------------------------------------------------
insert into sys_user_language values (1, 'error_load_thematic_dataset', 'Error loading thematic map data');
------------------------------------------------------------
