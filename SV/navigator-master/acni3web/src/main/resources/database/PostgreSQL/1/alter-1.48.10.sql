...
CREATE OR REPLACE FUNCTION alterDatabase()
 RETURNS void AS $$
DECLARE 
	_expectedVersion varchar = '1.48.9';
	_newVersion varchar = '1.48.10';
	_version varchar;
BEGIN
	-- check version
...
------------------------------------------------------------
insert into sys_user_language values (1, 'ValueMustBeBetween0and2', 'Overrun value must be between 0 and 2');
------------------------------------------------------------
