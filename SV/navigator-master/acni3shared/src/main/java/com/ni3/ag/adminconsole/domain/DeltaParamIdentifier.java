...
public class DeltaParamIdentifier{
	...
	public static final DeltaParamIdentifier CopyFavoriteFavoriteId = new DeltaParamIdentifier("CopyFavoriteFavoriteId");
	public static final DeltaParamIdentifier CopyFavoriteFolderId = new DeltaParamIdentifier("CopyFavoriteFolderId");
	public static final DeltaParamIdentifier CopyFavoriteName = new DeltaParamIdentifier("CopyFavoriteName");
	public static final DeltaParamIdentifier CopyFavoriteGroupFolder = new DeltaParamIdentifier("CopyFavoriteGroupFolder");
	...
	static{
		...
		entryMap.put(CopyFavoriteFavoriteId.getIdentifier(), CopyFavoriteFavoriteId);
		entryMap.put(CopyFavoriteFolderId.getIdentifier(), CopyFavoriteFolderId);
		entryMap.put(CopyFavoriteName.getIdentifier(), CopyFavoriteName);
		entryMap.put(CopyFavoriteGroupFolder.getIdentifier(), CopyFavoriteGroupFolder);
