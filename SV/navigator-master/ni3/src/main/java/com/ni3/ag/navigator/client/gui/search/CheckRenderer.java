...
public class CheckRenderer extends JPanel implements TreeCellRenderer{
	...
	public Component getTreeCellRendererComponent(JTree tree, Object value, boolean isSelected, boolean expanded,
		...
		// TODO rewrite, do not user global fields
		if (SystemGlobals.MainFrame != null && SystemGlobals.MainFrame.Doc != null && SystemGlobals.MainFrame.Doc.DB != null
				&& SystemGlobals.MainFrame.Doc.DB.getDataFilter() != null && ((CheckNode) value).value != null){
			if (SystemGlobals.MainFrame.Doc.DB.getDataFilter().checkExclusion(((CheckNode) value).value.getId())){
				check.setEnabled(false);
				label.setEnabled(false);
				((CheckNode) value).setEnabled(false);
			} else{
				check.setEnabled(true);
				label.setEnabled(true);
				((CheckNode) value).setEnabled(tree.isEnabled());
			}
		}
