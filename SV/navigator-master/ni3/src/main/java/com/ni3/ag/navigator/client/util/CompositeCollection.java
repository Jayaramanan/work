 ...
 * <p>
 * Changes made to this collection will actually be made on the decorated collection. Add and remove operations require
 * the use of a pluggable strategy. If no strategy is provided then add and remove are unsupported.
 * 
 ...
 * @author Phil Steitz
 */
@Deprecated // remove with PrimitiveIntMap
...
public class CompositeCollection implements Collection{
	 ...
	 * 
	 * @return an <code>IteratorChain</code> instance which supports <code>remove()</code>. Iteration occurs over
	 *         contained collections in the order they were added, but this behavior should not be relied upon.
	 * @see IteratorChain
	 */
	...
	/**
	 * Returns an object array, populating the supplied array if possible. See <code>Collection</code> interface for
	 * full details.
	 * 
	 * @param array
	...
	/**
	 * Adds an object to the collection, throwing UnsupportedOperationException unless a CollectionMutator strategy is
	 * specified.
	 * 
	 * @param obj
	 *            the object to add
	...
	/**
	 * Removes an object from the collection, throwing UnsupportedOperationException unless a CollectionMutator strategy
	 * is specified.
	 * 
	 * @param obj
	 ...
	 * <p>
	 * This implementation calls <code>contains()</code> for each element in the specified collection.
	 * 
	 * @param coll
	...
	/**
	 * Adds a collection of elements to this collection, throwing UnsupportedOperationException unless a
	 ...
	 * 
	 * @return A new ArrayList containing all of the elements in this composite. The new collection is <i>not </i>
	 *         backed by this composite.
	 */
