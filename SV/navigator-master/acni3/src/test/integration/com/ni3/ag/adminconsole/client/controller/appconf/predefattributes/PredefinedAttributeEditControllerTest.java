/** * Copyright (c) 2009-2015 Social Vision GmbH. All rights reserved. */ package com.ni3.ag.adminconsole.client.controller.appconf.predefattributes;

import java.util.ArrayList;

import com.ni3.ag.adminconsole.client.model.PredefinedAttributeEditModel;
...
public class PredefinedAttributeEditControllerTest extends ACTestCase{
	...
	protected void setUp() throws Exception{
		//PredefinedAttributeEditView view = new PredefinedAttributeEditView();
		//model = new PredefinedAttributeEditModel();
		controller = (PredefinedAttributeEditController) ACSpringFactory.getInstance().getBean("predefinedAttributeEditController");
