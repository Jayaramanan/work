...
public class UserActivityTableModelUser extends ACTableModel{
	private static final long serialVersionUID = 1L;
	static final DateFormat DATE_FORMAT = new SimpleDateFormat(DataType.DATE_TIME_FORMAT);

	private JTree tree;

	UserActivityTableModelUser(){
		addColumn(get(TextID.Action), false, TreeModel.class, false);
		addColumn(get(TextID.DateTime), false, String.class, false);
	}

	public UserActivityTableModelUser(JTree tree){
		this();
		this.tree = tree;
	...
	String getActivityTime(Object node){
